...
public class SpiderMain {
     ...
     * @return
     */
    private static Car getCarInfoFromUrl(String car_detail_url) throws IOException, ParseException {
        if (null != car_detail_url) {
            ...
            car = new Car();
            //1.车辆信息id
            car.setCid(UUID.randomUUID().toString().replaceAll("-", ""));
            ...
            //3.二手车图片
            String car_photo = "http:" +  doc.select(".swiper-slide-active a img").first().attr("src");
...
//            System.out.println(car_price);
            ...
            //6.车辆类型
            car.setCar_grade(car_base_infos[3]);
...
//            System.out.println(transfers_times);
            ...
            //17.车辆级别
            String car_grade = car_content[23].substring(4);
            car.setCar_grade(car_grade);
//            System.out.println(car_grade);

            //18.车辆发动机
            String car_engine = car_content[20].substring(1) + " " + car_content[21] + " " + car_content[22];
            car.setCar_engine(car_engine);
//            System.out.println(car_engine);

            //19.车辆颜色
            String car_color = car_content[24].substring(4);
            car.setCar_color(car_color);
//            System.out.println(car_color);

            //20.燃油标号
            String fuel_type = car_content[25].substring(4);
            car.setFuel_type(fuel_type);
//            System.out.println(fuel_type);

            //21.驱动方式
            String power_type = car_content[26].substring(4);
...
//            System.out.println(power_type);
     ...
     * @throws IOException
     */
    private static Document handleUrls(String url) throws IOException {
        //复用WebDriver
     ...
     * @throws IOException
     */
    private static List<Car> getDetailInfoFromPageUrls(List<String> car_pages_urls) throws IOException, ParseException {
